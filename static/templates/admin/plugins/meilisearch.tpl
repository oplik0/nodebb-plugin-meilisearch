<form role="form" class="meilisearch-settings">
	<div class="row">
		...
		<div class="col-sm-10 col-xs-12">
			<p class="lead">
				...
				<code>meta.settings.get('meilisearch', function(err, settings) {...});</code>
			</p>
	...
	<div class="row">
		...
		<div class="col-sm-10 col-xs-12">
			<div class="form-group" data-type="sorted-list" data-sorted-list="sample-list" data-item-template="admin/plugins/meilisearch/partials/sorted-list/item" data-form-template="admin/plugins/meilisearch/partials/sorted-list/form">
